			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="clearfix mb30 hidden-xs">
						<a href="<?php echo CMS_JOBS_PATH;?>" class="btn btn-gray pull-left">Back to Listings</a>
					...
					<div class="jobs-item jobs-single-item">
                        ...
                        <div class="thumb"><a href="javascript:void(0)" ><img src="<?php echo COMPANY_AVATAR_PATH ?><?php echo $companyData->cmp_logo_image_path;?>" alt=""></a></div>
						<div class="date"><?php echo date_format(date_create($jobDataObj->job_created_on),"d");?><span><?php echo date_format(date_create($jobDataObj->job_created_on),"M");?></span></div>
						<h6 class="title"><a href="javascript:void(0)"><?php echo $jobDataObj->job_role;?></a></h6>
						<span class="meta"><?php echo $jobDataObj->job_state_name.','.$jobDataObj->job_city_name.'-'.$jobDataObj->job_location_zip;?></span>
						<ul class="top-btns">
							<li><a href="javascript:void(0)" class="btn btn-default fa fa-star"></a></li>
						...
						<?php
						if(isset($jobDataObj->job_key_skills)){
							$keySkills=explode(",",$jobDataObj->job_key_skills);
							foreach($keySkills as $skillKey=>$skill){
								echo "<li>$skill</li>";
							}
						}
						?>
