			...
			<div class="container">
				...
				<nav>
					<ul class="primary-nav">
						...
						<li ><a href="<?php echo CAND_SEARCH_JOB?>">Search Job</a></li>
						<li ><a href="<?php echo CAND_UPDATE_RESUME?>">Upadate Resume</a></li>
                        <li class="active"><a href="<?php echo CAND_PROFILE?>">Account</a></li>
                        <li class="has-submenu ">
							...
							<ul>
								<li><a href="<?php echo CAND_PROFILE?>"><i class="fa fa-user pr10"></i>Account</a></li>
