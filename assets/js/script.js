...
// ---------------------------------------------------------
var $headerLoginRegister = $('.header-login, .header-register');
...
// Mobile Toggle
var $headerLoginClone = $('.header-login > .btn').clone(false).removeClass('.btn-link').addClass('clone btn-default mobile-login-toggle'),
	$headerRegisterClone = $('.header-register > .btn').clone(false).removeClass('.btn-link').addClass('clone btn-default mobile-register-toggle');
...
function headerLoginRegister(XS) {
	if (XS.matches) {
		...
		$headerLoginRegister.insertAfter($('.header-top-bar .container .bookmarks'));
...
// Latest testimonial Section Slider
// ---------------------------------------------------------
if ($.fn.flexslider && $('.latest-testimonial').length > 0) {
	$('.latest-testimonial .flexslider').flexslider({
		pauseOnHover: true,
		controlNav: true,
		directionNav: false,
		slideshow: true,
